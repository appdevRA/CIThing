<html>
	...
	<body background="<?php echo base_url('images/img1.gif'); ?>">
		...
		<div id="menu">
		  <ul>
		    <li ><a href="homepage.html" accesskey="1">Homepage</a></li>
		    <li class="active"><a href="" accesskey="1">My Blog</a></li>
		    <li><a href="#" accesskey="1">Photo Gallery</a></li>
		    <li><a href="#" accesskey="1">Favorite Sites</a></li>
		...
		<div id="content">
		  ...
		  <div id="colTwo">
		    ...
		    <p class="byline">Posted in <a href="#">Uncategorized</a> by Farmer on the December 6th, 2006</p>
		    <p><strong>The Barn</strong> is a free template from Free CSS Templates released under a <a href="">Creative Commons Attribution 2.5 License</a>. The header photo is from PDPhoto.org. You're free to use this template for both commercial or personal use. I only ask that you link back to my site in some way.</p>
		    <p><strong><em>Enjoy! :)</em></strong></p>
		    <h3>Lorem Ipsum Dolorem</h3>
		    <p class="byline">Posted in <a href="#">Uncategorized</a> by Farmer on the December 6th, 200 </p>
